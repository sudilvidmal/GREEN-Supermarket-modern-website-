...
<html>
<head>
    <title>Food Corner Bakery</title>
    <meta charset="utf-8">
    ...
    <div class="container my-5">
        <div class="row" id="product_details">
            <div class="col-md-5">
                <div class="main-img">
                    <img class="img-fluid"
                         src="images/mohamed-hassouna-N4gtuEZ5gWc-unsplash.jpg"
                         alt="ProductS">
            ...
            <div class="col-md-7">
                <div class="main-description px-2">
                    ...
                    <div class="price-area my-4">
                        ...
                        <p class="new-price text-bold mb-1">Rs 100 - 1000</p>
                ...
                <div class="product-details my-4">
                    ...
                    <p class="description">bread<br><br>
                        Whole Wheat Bread<br><br>
                        Sliced White Bread<br><br>
                        Rye Bread<br><br>
                        Baguette
