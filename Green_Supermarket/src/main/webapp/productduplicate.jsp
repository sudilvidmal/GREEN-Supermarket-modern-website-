        ...
        <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary ">
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                ...
                <div class="offcanvas-header">
                    <img src="images/green-supermarket-high-resolution-logo-transparent.png" class="w-50" alt=""/>
                ...
                <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 " aria-current="page" href="sample.jsp">
                                <svg class="bi">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="customer.jsp">
                                <svg class="bi">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2" href="dashfeedback.jsp">
                                <svg class="bi">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="order_details.jsp">
                                <svg class="bi">
                ...
                <div class="row">
                    <div class="col-sm-3 col-md-3 col-lg-2   pt-3 px-3">
                        ...
                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#add_productmodal">
                            Add Product
                        </button>
                    </div>
                    <div class="col-sm-3 col-md-3 col-lg-2   pt-3 px-3">
                        <div>
                            <jsp:include page="update_product.jsp"/>
                        </div>
                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#update_productmodal">
                            Update Product
                        </button>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-2   pt-3 px-3">
                        <div>
                            <jsp:include page="delete_product.jsp"/>
                        </div>
                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#delete_productmodal">
                            Delete Product
                        </button>
                    </div>
                    <div class="col-sm-3 col-md-3 col-lg-2   pt-3 px-3">
